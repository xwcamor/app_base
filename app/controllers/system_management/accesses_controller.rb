module SystemManagement  # Main Folder
  class AccessesController < ApplicationController  # Controller Name
    # Autentication
    ...
    def search      
      permitted_params = params.require(:q).permit(:resource_name_cont, :action_name_cont)
    ...
    def index
      ...
      if request.format.xlsx?
        @list_array = @query.result.order("resource_name DESC")
      else
        @list_array = @query.result.order("resource_name DESC").page(params[:page])
      end
